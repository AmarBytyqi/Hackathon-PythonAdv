...
const apiClient = {
    ...
    async login (username, password) {
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticateUser"])(username, password);
        return user;
    },
    async register (username, password, name, profilePicture) {
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerParent"])(username, password, name, profilePicture);
        return user;
    },
    // Students
    async getStudents () {
        const students = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllStudents"])();
        return students;
    },
    async addStudent (name, surname, age, parentId) {
        const student = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addStudent"])(name, surname, age, parentId);
        return student;
    },
    async deleteStudent (studentId) {
        const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteStudent"])(studentId);
        return success;
    },
    async getStudentProfile (studentId) {
        const student = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStudent"])(studentId);
        const grades = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStudentGrades"])(studentId);
        if (student && grades) {
            return {
                student,
                grades
    ...
    async addGrade (studentId, subject, grade, teacher, comment) {
        const gradeEntry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addGrade"])(studentId, subject, grade, teacher, comment);
        return gradeEntry;
    },
    // Attendance
    async addAttendance (studentId, status, subject, teacher, notes) {
        const record = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addAttendance"])(studentId, status, subject, teacher, notes);
        return record;
    },
    async getAttendance (studentId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStudentAttendance"])(studentId);
    },
    // Assignments
    async createAssignment (title, description, subject, dueDate, createdBy) {
        const assignment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAssignment"])(title, description, subject, dueDate, createdBy);
        return assignment;
    },
    async getAssignmentsBySubject (subject) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAssignmentsBySubject"])(subject);
    },
    async getAllAssignments () {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllAssignments"])();
    },
    async updateSubmission (studentId, assignmentId, status, grade, feedback) {
        const submission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateSubmissionStatus"])(studentId, assignmentId, status, grade, feedback);
        return submission;
    },
    async getSubmissions (studentId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStudentSubmissions"])(studentId);
    },
    // GPA Calculation
    async calculateGPA (studentId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateGPA"])(studentId);
    },
    // Messages
    async sendMessage (from, to, subject, content) {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadDatabase"])();
        ...
        db.messages[messageId] = message;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveDatabase"])(db);
        return message;
    },
    ...
    async createStudentAccount (studentId, studentUsername, studentPassword) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createStudentAccount"])(studentId, studentUsername, studentPassword);
    },
    // Messaging functions are already included above
    async getAllTeachers () {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllTeachers"])();
    },
    async getAllParents () {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllParents"])();
    },
    async getStudentsByParent (parentUsername) {
        const students = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStudentsByParent"])(parentUsername);
        return students;
    },
    async createExam (title, subject, date, startTime, endTime, createdBy) {
        const exam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createExam"])(title, subject, date, startTime, endTime, createdBy);
        return exam;
    },
    async getExamsBySubject (subject) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getExamsBySubject"])(subject);
    },
    async getAllExams () {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllExams"])();
    },
    async deleteExam (examId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteExam"])(examId);
    },
    async deleteAssignment (assignmentId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteAssignment"])(assignmentId);
    }
};
}),
"[project]/components/avatar-selector.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$avatar$2d$selector$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/avatar-selector.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Home() {
    ...
    const [registerUsername, setRegisterUsername] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [registerName, setRegisterName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [selectedAvatar, setSelectedAvatar] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("/images/shadow-walking-front.png");
    ...
    const handleLogin = async (e)=>{
        ...
        setError("");
        setLoading(true);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].login(loginUsername, loginPassword);
        setLoading(false);
        if (user) {
    ...
    const handleRegister = async (e)=>{
        ...
        setError("");
        setLoading(true);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].register(registerUsername, registerPassword, registerName, selectedAvatar);
        setLoading(false);
        if (user) {
            localStorage.setItem("user", JSON.stringify(user));
            router.push("/parent/dashboard");
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TabsContent"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$avatar$2d$selector$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AvatarSelector"], {
...
//# sourceMappingURL=_83cdfb25._.js.map